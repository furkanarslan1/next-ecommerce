...
export default function Navbar() {
  ...
  <Image src="/e-commerce-brand.webp" alt='e-commerce-logo' fill className='object-contain'/>
</div>
 ...
 <div className='hidden md:flex items-center gap-4 '>
        ...
        <Link href="/login" className='text-slate-500 text-sm hidden md:block'>Sign in</Link>
